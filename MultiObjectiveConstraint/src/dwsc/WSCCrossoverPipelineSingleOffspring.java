...
public class WSCCrossoverPipelineSingleOffspring extends BreedingPipeline {
	...
	public int produce(int min, int max, int start, int subpopulation,
        ...
        for(int q=start,x=0; q < nMin + start; q++,x++) {
    		...
    		// Choose the candidate with the best fitness
    		if (t1.fitness.betterThan(t2.fitness))
    			inds[q] = t1;
    		else
    			inds[q] = t2;
