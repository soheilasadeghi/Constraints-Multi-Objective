...
public class WSCMultiObjectiveStatistics extends MultiObjectiveStatistics {
	...
	public void individualStringRepresentation( SequenceVectorIndividual ind, StringBuilder builder, boolean finalFront, EvolutionState state) {
		...
		builder.append("r=ank");
		builder.append(f.rank);
		builder.append(" sparsity=");
...
//		builder.append(" ");
		builder.append("objective1=");
		builder.append(objectives[0]);
		builder.append(" objective2=");
		builder.append(objectives[1]);
		builder.append(" ");

		builder.append(ind.getCTime());
		builder.append("=CTime");
		builder.append(ind.getCCost());
		builder.append("=CCost");
		builder.append(ind.getDTime());
		builder.append("=DTime");
		builder.append(ind.getDCost());
